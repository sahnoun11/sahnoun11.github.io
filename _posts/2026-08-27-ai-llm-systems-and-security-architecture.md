---
title: "Inside the AI Stack — The Foundation Every AI Security Assessment Starts From"
...
*For the offensive walkthrough of these patterns — live payloads against a real pipeline — see [Web LLM Attacks Part 2, §3: Exploiting RAG Pipelines](/posts/Web-LLM-Attack-Part2/#3-exploiting-rag-pipelines).*
...
This is **LLM09: Vector and Embedding Weaknesses** in the OWASP list, and its scope expanded in the 2026 edition. *See also [Web LLM Attacks Part 2, §4: Attacking Embeddings & Vector Databases](/posts/Web-LLM-Attack-Part2/#4-attacking-embeddings--vector-databases) for the inversion attack walkthrough.*
